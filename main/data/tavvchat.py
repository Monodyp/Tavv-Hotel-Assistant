...
device1_token = read_device_token(r"tokens/device1_token.txt")
device2_token = read_device_token(r"tokens/device2_token.txt")
device3_token = read_device_token(r"tokens/device3_token.txt")
